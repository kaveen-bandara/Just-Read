            ...
            <div className='w-full max-w-sm mx-auto bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4'>
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                    <div className='mb-4'>
                        ...
                        <input {...register('email', {required: true})} type='email' name='email' id='email' placeholder="Email"
                ...
                <p className='mt-5 text-center text-gray-500 text-xs'>©2025 JustRead Book Store. All rights reserved.</p>
            </div>
        </div>
    );
};
