                                ...
                                <div className='lg:col-span-2'>
                                    <div className='grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5'>
                                        ...
                                        <div className='md:col-span-5'>
                                            ...
                                            <input {...register('phone', {required: true})} type='number' name='phone' id='phone' 
                                            className='h-10 border mt-1 rounded px-4 w-full bg-gray-50' placeholder="+94" />
                                        </div>

                                        <div className='md:col-span-3'>
                                            <label htmlFor='address'>Address</label>
                                            <input {...register('address', {required: true})} type='text' name='address' id='address' 
                                            className='h-10 border mt-1 rounded px-4 w-full bg-gray-50' placeholder="Address" />
                                        </div>

                                        <div className='md:col-span-2'>
                                            <label htmlFor='city'>City</label>
                                            <input {...register('city', {required: true})} type='text' name='city' id='city' 
                                        ...
                                        <div className='md:col-span-2'>
                                            ...
                                            <div className='h-10 bg-gray-50 flex border border-gray-200 rounded items-center mt-1'>
                                                <input {...register('country', {required: true})} name='country' id='country' 
                                                placeholder="Country" className='px-4 appearance-none outline-none text-gray-800 w-full bg-transparent' />
                                        ...
                                        <div className='md:col-span-2'>
                                            ...
                                            <div className='h-10 bg-gray-50 flex border border-gray-200 rounded items-center mt-1'>
                                                <input {...register('state', {required: true})} name='state' id='state' placeholder="State" 
                                        ...
                                        <div className='md:col-span-1'>
                                            ...
                                            className='transition-all flex items-center h-10 border mt-1 rounded px-4 w-full bg-gray-50' placeholder="" />
                                        </div>
                                        ...
                                        <div className='md:col-span-5 mt-3'>
                                            <div className='inline-flex items-center'>
                                                ...
                                                <label htmlFor='billing_same' className='ml-2'>I agree to the <Link className='underline underline-offset-2 text-blue-600'>
                                                    Terms & Conditions</Link> and <Link className='underline underline-offset-2 text-blue-600'>Shoping Policy.</Link>
                                                </label>
                                            </div>
                                        </div>
